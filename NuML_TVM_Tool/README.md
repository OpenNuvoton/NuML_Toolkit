...
* Build
    ~~~
    python numl_tool.py build --project_path ..\..\yyy\ProjGen_NuMaker-M55M1 [--ide_tool C:\Keil_v5\UV4\UV4.exe]
    ~~~
    * Parameter
...
* For make_gcc_arm
    ...
    python numl_tool.py build --project_path ..\..\yyy\ProjGen_NuMaker-M55M1   
